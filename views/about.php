  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 text-white">
        ...
        <p class="text-black">
          Our goal is to become the most trusted and community-driven delivery service in our region, known for our commitment to local partnerships, innovation in last-mile logistics, and a people-first approach to business.
        </p>
        <p class="text-black">
